...
# VOLUME instruction removed for Railway deploys: Railway's builder rejects
# Dockerfiles with VOLUME ("use Railway Volumes instead"). Persistence is
# provided by an attached Railway Volume mounted at /opt/data.
